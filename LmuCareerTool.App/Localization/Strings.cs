...
public static class Strings
{
    ...
    private static readonly Dictionary<string, (string Nb, string En)> Map = new()
    {
        ...
        ["Main_Nav_Season"] = ("📅  Sesongkalender", "📅  Season Calendar"),
        ["Main_Nav_Championship"] = ("🏆  Mesterskap", "🏆  Championship"),
        ["Main_Nav_History"] = ("📜  Historikk", "📜  History"),
        ["Main_Nav_TransferMarket"] = ("🔁  Transfermarked", "🔁  Transfer market"),
        ["Main_Nav_Achievements"] = ("🎖️  Prestasjoner", "🎖️  Achievements"),
        ["Main_Nav_Staff"] = ("👔  Stab", "👔  Staff"),
        ["Main_Nav_Events"] = ("🏁  Spesialarrangementer", "🏁  Special events"),
        ...
        ["Main_Header_Safety"] = ("SIKKERHET", "SAFETY"),
        ...
        ["Main_Log_ApprovedManually"] = ("✅ Godkjent manuelt: {0} - +{1} XP, +{2} poeng, Driver {3}, Safety {4}, +{5} cr", "✅ Approved manually: {0} - +{1} XP, +{2} points, Driver {3}, Safety {4}, +{5} cr"),
        ["Main_Log_RaceResult"] = ("🏁 {0}: P{1} av {2} - +{3} XP, +{4} poeng, Driver {5}, Safety {6}, +{7} cr", "🏁 {0}: P{1} of {2} - +{3} XP, +{4} points, Driver {5}, Safety {6}, +{7} cr"),
        ...
        ["Main_Log_AchievementUnlocked"] = ("🏆 Prestasjon låst opp: {0}!", "🏆 Achievement unlocked: {0}!"),
        ["Main_Toast_AchievementUnlocked"] = ("Prestasjon låst opp: {0}!", "Achievement unlocked: {0}!"),
